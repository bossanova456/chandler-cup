...
const MatchupTable = ({ matchups, savedPicks, unsavedPicks, teams, user, updateUnsavedPicks, setScoreUpdateModalOpen }) => {
						...
						Object.keys(matchups)
							...
							.map((matchupId, i) => {
								return <MatchupTableRow 
											...
											setScoreUpdateModalOpen={setScoreUpdateModalOpen}
										/>
						})
					}
				</tbody>
